...
from pipeline import generate_ui_from_difftree
...
def run_pi(session, log, pre_generalize):
  ...
  ui = generate_ui_from_difftree(log, catalog, db)
...
if __name__ == "__main__":
    ...
    socketio.run(app, host='0.0.0.0', port=8888, processes=1, debug=True)
