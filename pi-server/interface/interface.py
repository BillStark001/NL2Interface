...
class Interface(object):
    ...
    def __init__(self, difftrees, layouts, mappings, Exp):
    ...
    def cost(self):
        ...
        w = max(self.layouts.width - self.Exp.max_width, 0) * 0.01 + 1
        h = max(self.layouts.height - self.Exp.max_height, 0) * 0.01 + 1
